                                                        ...
                                                        <Form {...form}>
                                                                <form
                                                                        onSubmit={form.handleSubmit(async (data) => {
                                                                                try {
                                                                                        const response = await fetch(`${SERVER_LOCAL_URL}/project/analyze`, {
                                                                                                method: "POST",
                                                                                                headers: {
                                                                                                        "Content-Type": "application/json",
                                                                                                },
                                                                                                body: JSON.stringify({ project_path: data.project }),
                                                                                        });
                                                                                        const responseData = await response.json();
                                                                                        if (responseData.blueprint) {
                                                                                                // Create a new project with the analyzed blueprint
                                                                                                const projectName = data.project.split("/").pop();
                                                                                                const createResponse = await fetch(`${SERVER_LOCAL_URL}/projects/new`, {
                                                                                                        method: "POST",
                                                                                                        headers: {
                                                                                                                "Content-Type": "application/json",
                                                                                                        },
                                                                                                        body: JSON.stringify({
                                                                                                                project: projectName,
                                                                                                                description: `Analyzed from existing project at ${data.project}`,
                                                                                                                blueprint: responseData.blueprint
                                                                                                        }),
                                                                                                });
                                                                                                const createData = await createResponse.json();
                                                                                                navigate(`/project/${createData.project}`);
                                                                                        }
                                                                                } catch (error) {
                                                                ...
                                                                >
                                                                        <FormField
                                                                                ...
                                                                                render={({ field }) => (
                                                                                        <FormItem>
                                                                                                <FormLabel className="font-light text-base">Project Path</FormLabel>
                                                                                                <FormControl>
                                                                                                        <Input
                                                                                                                {...field}
                                                                                                ...
                                                                                                <FormDescription className="text-[#aaa] text-sm">
                                                                                                        The absolute path to your existing project
                                                                                                </FormDescription>
                                                                                                <FormMessage />
                                                                                        </FormItem>
                                                                                )}
